...
/**
 * @custom:journal JOURNAL 2 (primary) + JOURNAL 3 (extended)
 *
 * Journal 2 — "Decentralised Identifier-Anchored Verifiable Credentials with
 *   On-Chain Revocation for Social Media Identity Management"
 *   Venue: IET Blockchain (Wiley) | Submitted: 2026-05-13
 *   Role: Core contract evaluated in this paper. All gas measurements
 *         (createDID = 346,878 gas; revokeCredential = 171,188 gas) use
 *         this contract. Tested by test/DIDRegistry.test.js (30 tests) and
 *         test/VerifiableCredential.test.js (17 tests).
 *
 * Journal 3 — Privacy-Preserving ZK Credential Verification (in progress)
 *   Role: Foundation layer reused without modification. Journal 3 adds
 *         ZKVerifier.sol on top; DIDRegistry provides DID resolution.
 *
 * @title DIDRegistry
 * @author PhD Research - Blockchain-based Privacy-Preserving IAM
 * @notice Enhanced Decentralized Identifier (DID) Registry with full W3C DID compliance
 * @dev Implements DID creation, resolution, updates, revocation, and key rotation
 */
